...
use App\Rules\Promotion\BuyProductTakeGiftRule;
use App\Rules\Promotion\BuyComboRule;
    ...
    public function rules(): array
    {
        ...
        switch ($method) {
            ...
            case PromotionEnum::BUY_PRODUCT_TAKE_GIFT:
                $rules['method'] = [new BuyProductTakeGiftRule($this->only('products', 'product_gifts'))];
                break;
            case PromotionEnum::BUY_COMBO:
                $rules['method'] = [new BuyComboRule($this->only('product_combos'))];
                break;
            default:
